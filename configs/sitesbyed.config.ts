    ...
    rows: [
      {
        ...
        agency: '$20,000–$25,000 up front, then a monthly retainer',
        us: '$1,500–$3,000 once, and that’s the whole invoice',
      },
      {
        label: 'Who builds it',
        diy: 'You, alone, at 11pm',
        agency: 'A team you meet in the pitch, then whoever they assign',
        us: 'A person, start to finish',
      },
      {
        label: 'The code',
        diy: 'A shared template, reused on thousands of other sites',
        agency: 'Custom, but often tied to a platform you can’t take with you',
        us: 'Built specifically for your business, and yours to keep',
      },
      {
        label: 'Load speed',
        diy: 'Often 3–5+ seconds, builder overhead included',
        agency: 'Usually decent, until the plugins and trackers pile up',
        us: 'Typically under 1 second',
      },
      {
        label: 'Looks like',
        diy: 'A Wix site — because it is one',
        agency: 'Polished, and a lot like their last six clients',
        us: 'A site someone actually built for you',
      },
      {
        label: 'When something breaks',
        diy: 'A help center article',
        agency: 'A support ticket, and a place in the queue',
        us: 'A text, email, or call to Ed',
      },
      {
        label: 'Getting found',
        diy: 'Bolted on after the fact',
        agency: 'Built in, then billed again every month as “SEO”',
        us: 'Built in from page one, at no added cost',
      },
      {
        label: 'After launch',
        diy: 'You keep paying the subscription, or the site goes away',
        agency: 'A proposal for phase two, then phase three',
        us: 'Optional hosting, or nothing at all — your call',
      },
    ],
  },
  foundations: {
